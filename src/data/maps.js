...
export const MAPS = {
  ...
  millhollow: {
    ...
    npcs: [
      {"x": 3, "y": 6, "kind": "recruit", "id": "garrick", "name": "Garrick",
  ...
  ashquarry: {
    ...
    npcs: [
      {"x": 3, "y": 6, "kind": "recruit", "id": "doran", "name": "Doran",
  ...
  farview: {
    ...
    npcs: [
      {"x": 3, "y": 6, "kind": "recruit", "id": "wyn", "name": "Wyn",
  ...
  valesend: {
    ...
    npcs: [
      {"x": 3, "y": 6, "kind": "recruit", "id": "mireth", "name": "Mireth",
