...
export default async function RentalsPage({
  ...
  const href = (at: string) => `/dispatch/rentals?at=${at}${quarter ? "&span=quarter" : ""}`;
        ...
        <div className="card-head">
          ...
          <div className="btn-row">
            ...
            <Link
              ...
              href={quarter ? "/dispatch/rentals?span=quarter" : "/dispatch/rentals"}
            >
              Now
            </Link>
            <Link className="btn btn-sm" href={href(step(1))}>
            ...
            <Link
              className="btn btn-sm"
              href={
                quarter ? `/dispatch/rentals?at=${anchor}` : `/dispatch/rentals?at=${anchor}&span=quarter`
              }
            >
